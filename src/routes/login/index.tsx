      ...
      <section>
        <div class="max-w-sm mx-auto pt-8 px-4 sm:pt-6 sm:px-6 h-[60vh]">
          <div class="card rounded-none dark:bg-slate-800">
            <h1 class="text-2xl font-bold leading-tighter text-center tracking-tighter mb-4 mt-1 font-heading">Login</h1>
            ...
            <div class="text-center mt-4">
              <a href="/register" class="text-sm font-medium text-gray-900 dark:text-white">Create Account</a>
            </div>
          </div>
        </div>
      </section>
